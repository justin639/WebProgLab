...
function checkForm() {
    ...
    // check empty title, add error massage
    if ($("input[name=title]").val() !== '') {
        check_title = true;
    } else {
        error += 'No input title!\n'
    }

    // check empty type, add error massage
    ...
    // check empty description, add error massage
    ...
    if (check_url && check_type && check_title && check_description === true) {
        return true;
    } else {
        return error;
    }
            ...
            <div class="card text-center" style="width: 25rem;">
                ...
                <img src="${item.img_url}"
                    ...
                    <div class="card-body">
                        ...
                        <a href="${item.img_url}" class="btn btn-primary round">${item.type}</a>
                    </div>
            </div>
        </div>`;
